...
def pantalla_nivel_2():
    ...
    # Número de tile a poner en mesa según nombre del ingrediente
    mesa_tiles1 = {
        "Carne":                       16,
        "Carne_cocinada":              15,
        "Tomate":                      25,
    ...
    # ── Estado de procesamiento por estación ─
    ...
    def encontrar_estacion_cercana(chef):
        """Devuelve el tipo de la estación más cercana al centro del chef."""
    ...
    def pos_estacion(tipo_estacion):
        """Devuelve el topleft (x,y) de la estación con ese tipo."""
        for estacion in world.estaciones_tiles:
    ...
    def nombre_tile_para_ingrediente(ing):
        """Devuelve la clave de mesa_tiles1 correcta según tipo y estado."""
    ...
    def ingrediente_desde_tile(num):
        ...
        if num == 15:
            ...
            return Proteina("Carne")
        elif num == 26:
            ing = VegetalesYFrutas("Tomate")
            ing.estado = "preparado"
            return ing
        elif num == 25:
            return VegetalesYFrutas("Tomate")
        elif num == 23:
            ing = VegetalesYFrutas("Papa")
            ing.estado = "preparado"
            return ing
        elif num == 22:
            return VegetalesYFrutas("Papa")
        elif num == 24:
            ...
            if event.type == pygame.KEYDOWN:
                ...
                for chef in cocina.chefs:
                    ...
                    if chef.ingrediente_mano is None:
                        ...
                        # Recoger ingrediente listo de estación de cocción
                    ...
                    # ══════════════════════════════════════
                        ...
                        # Dejar tomate en tabla de picar
                        ...
                        # Dejar en mesa vacía (respetando estado del ingrediente)
                        elif tipo == "mesa":
                    ...
                    # ══════════════════════════════════════
                        ...
                        # Agregar pan desde despensa directamente
